...
/**
 * This is the item provider adapter for a {@link turtle.Forward} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Forward_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Forward_length_feature", "_UI_Forward_type"),
				 TurtlePackage.Literals.FORWARD__LENGTH,
				 true,
				 false,
				 false,
