...
/**
 * This is the item provider adapter for a {@link turtle.Choreography} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoreographyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TurtlePackage.Literals.CHOREOGRAPHY__SEQUENCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Choreography.class)) {
			case TurtlePackage.CHOREOGRAPHY__SEQUENCE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TurtlePackage.Literals.CHOREOGRAPHY__SEQUENCE,
				 TurtleFactory.eINSTANCE.createForward()));

		newChildDescriptors.add
			(createChildParameter
				(TurtlePackage.Literals.CHOREOGRAPHY__SEQUENCE,
				 TurtleFactory.eINSTANCE.createRotate()));

		newChildDescriptors.add
			(createChildParameter
				(TurtlePackage.Literals.CHOREOGRAPHY__SEQUENCE,
				 TurtleFactory.eINSTANCE.createSetPen()));
	}
