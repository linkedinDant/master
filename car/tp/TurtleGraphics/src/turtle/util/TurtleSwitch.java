...
public class TurtleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TurtlePackage.SET_PEN: {
				SetPen setPen = (SetPen)theEObject;
				T result = caseSetPen(setPen);
				if (result == null) result = caseAction(setPen);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TurtlePackage.CHOREOGRAPHY: {
				Choreography choreography = (Choreography)theEObject;
				T result = caseChoreography(choreography);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TurtlePackage.FARM: {
				Farm farm = (Farm)theEObject;
				T result = caseFarm(farm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TurtlePackage.COLOR: {
				Color color = (Color)theEObject;
				T result = caseColor(color);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TurtlePackage.COLOURED_TURTLE: {
				ColouredTurtle colouredTurtle = (ColouredTurtle)theEObject;
				T result = caseColouredTurtle(colouredTurtle);
				if (result == null) result = caseTurtle(colouredTurtle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Set Pen</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Set Pen</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSetPen(SetPen object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Coloured Turtle</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Coloured Turtle</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColouredTurtle(ColouredTurtle object) {
		return null;
	}
